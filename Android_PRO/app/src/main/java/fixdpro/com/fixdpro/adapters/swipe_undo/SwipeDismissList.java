package fixdpro.com.fixdpro.adapters.swipe_undo;

/**
 * Created by Harwinder Paras on 11/15/2016.
 */
...
public final class SwipeDismissList implements View.OnTouchListener {
    ...
    public SwipeDismissList(AbsListView listView, OnDismissCallback callback, UndoMode mode) {
        ...
        mUndoPopup = new PopupWindow(v, WindowManager.LayoutParams.MATCH_PARENT, WindowManager.LayoutParams.WRAP_CONTENT, true);
