package fixdpro.com.fixdpro.views;
...
public class AutoScaleTextView extends TextView
{
	...
	private float initPrefereredTextSize;
	...
	public AutoScaleTextView(Context context, AttributeSet attrs, int defStyle)
	{
		...
		this.initPrefereredTextSize = this.getTextSize();
	}
	...
	private void refitText(String text, int textWidth)
	{
		...
		//customized adding  ----------------------------------------------
		this.minTextSize = 48;
		this.preferredTextSize = this.initPrefereredTextSize;
		//------------------------------------------------------------------
